...
document
  .querySelectorAll(".navbar-categories-li")[2]
  .addEventListener("click", function (event) {
    window.location.href = "./categorykids.html";
  });

document
  .querySelectorAll(".navbar-categories-li")[3]
  .addEventListener("click", function (event) {
    window.location.href = "./categoryhome.html";
  });

document
  .querySelectorAll(".navbar-categories-li")[4]
  .addEventListener("click", function (event) {
    window.location.href = "./beautypage.html";
  });

document
  .querySelectorAll(".navbar-profile-items")[2]
  .addEventListener("click", function () {
